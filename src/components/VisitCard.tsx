        ...
        <div className="is-flex visit-card-mobile-layout is-justify-content-space-between is-align-items-flex-start mb-4">
          <div className="is-flex-grow-1" style={{ width: '100%' }}>
            <div className="is-flex is-align-items-center mb-4">
              <User size={20} className="has-text-primary" style={{ marginRight: '0.75rem', flexShrink: 0 }} />
            ...
            <div className="content">
              <div className="is-flex is-align-items-center visit-detail-item" style={{ flexWrap: 'wrap', gap: '0.5rem' }}>
                <Clock size={18} className="has-text-grey" style={{ marginRight: '0.75rem', flexShrink: 0 }} />
              ...
              <div className="is-flex is-align-items-center visit-detail-item" style={{ flexWrap: 'wrap', gap: '0.5rem' }}>
                <Calendar size={18} className="has-text-grey" style={{ marginRight: '0.75rem', flexShrink: 0 }} />
              ...
              {visit.description && (
                <div className="is-flex is-align-items-flex-start mt-4" style={{ gap: '0.5rem' }}>
                  ...
                  <div>
                    ...
                    <p style={{ marginTop: '0.5rem' }}>{sanitizeText(visit.description)}</p>
                  </div>
                </div>
              )}
            </div>
